...
namespace PennyworthSL.Controllers
{
    [Route("api/IPSL")]
    [ApiController]
    public class InventoryPostingSLController : ControllerBase
    {
        [HttpPost]
        [ActionName("generar_contabilizacion")]
        [ProducesResponseType(typeof(InventoryPostingSL), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(InventoryPostingSL), StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> IPSL([FromBody] InventoryPostingSL body)
        {
            ...
            try
            {
                ...
                try
                {
                    string url = "https://hanab1:50000/b1s/v1/InventoryPostings";
